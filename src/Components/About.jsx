  ...
  return (
    <div className=" px-4 h-350 py-40 bg-[rgba(255,233,217,1)] md:h-200">
      ...
      <div className="md:flex md:justify-center  ">
        {" "}
        <div className="  md:py-20  md:flex-row w-full max-w-7xl gap-10">
          {/* Left Column */}
          <div className="flex flex-col gap-5 justify-center items-center md:items-start w-full md:w-1/2">
            <h3 className="text-2xl  md:ml-40 font-bold text-orange-400">
              Resume
            </h3>
            <h1 className="text-4xl md:text-6xl text-center md:text-center   md:w-300  font-bold">
              <span className="text-orange-400 ">A</span>ll over my details is
              here...
            </h1>
            <div className=" gap-10 md:flex    md:ml-20  px-4 md:px-5 md:gap-5 justify-center md:w-250 ">
              {tabs.map((tab, index) => (   
                <button
                  onClick={() => setActiveTab(index)}
                  key={`tab_${index}`}
                  className={`w-full mt-5  rounded-lg border py-4 font-bold md:py-4 md:border md:bg-white md:text-black md:font-bold md:text-start md:px-4 md:w-[80%] ${
          ...
          {/* Right Column */}
          <div className=" mt-10 md:flex justify-center gap-50">
            {" "}
            <div className="  md:mt-40 md:w-200">
